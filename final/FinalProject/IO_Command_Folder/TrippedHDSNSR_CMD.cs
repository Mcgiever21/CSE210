...
{
    public class CommandHDCM : CommandBase
    {
        private Camera _camera;
        private Terminal _terminal;
        //private VideoSave _videoSave;

        public CommandHDCM(Camera camera,Terminal terminal)
        {
            _camera = camera;
            _terminal = terminal;
        }
        ...
        public override void Execute()
        {
            ...
            _terminal.Write("Sensor tripped - vehicle hood has been opened, recording in progress");
